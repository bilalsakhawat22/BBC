...
const Buy = ({ connecctstatus, setConnectedstatus }) => {
  ...
  const [priceInEth, setPriceInEth] = useState(0.075);
  ...
  async function loadWeb3() {
    if (window.ethereum) {
      ...
      const contractaddress = "0x0be9ecb8c7c4963fb6c96cf9195a9c6898c52397";
          ...
          <div className="row mx-auto text-center">
            ...
            >
              <div className="col-md-12 btngroup ">
                <h1 className="mint-heading text-center">MINT A BIG BLACK COCK</h1>
                ...
                <div className="row border-btm">
                  <div className="col-md-12 mint-col">
                    ...
                    <h4 style={{ color: "white" }} className="float-right">5000</h4>
                  </div>
                </div>
                <div className="row border-btm">
                  <div className="col-md-12 mint-col">
                ...
                <p className="text-center py-5 what_inner_text ">
                  ...
                  <button className="c-button c-button--gooey btn mint-btn"
                  onClick={async () => {
                    await connectWallet();
                    await mint();
                  }}
